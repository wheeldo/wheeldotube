        ...
        function authenticateViaFacebook(parameters) {
            $http.post('/op', {op:'isFacebookUser', facebook_uid:parameters.facebook_id}).success(function(data, status, headers, config){
            	if(data.is_user) {
            		...
            		$http.post('/op', {op:'loginFacebookUser',token:FB.getAccessToken(), gid:gid}).success(function(data, status, headers, config){
            			stopProcessing();
            		...
            		$http.post('/op', {op:'registerFacebookUser',token:FB.getAccessToken(), gid:gid}).success(function(data, status, headers, config){
            			stopProcessing();
